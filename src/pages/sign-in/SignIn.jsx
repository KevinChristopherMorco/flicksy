  ...
  return (
    <div className="flex flex-col gap-10 py-[3%] md:gap-20">
      ...
      <div className="flex flex-col items-center">
        <div className="flex w-[90%] flex-col items-center gap-10 rounded-md border border-gray-300 p-6 md:w-[50%] md:p-10 lg:w-[40%] lg:p-10 xl:w-[30%] xl:p-10 2xl:w-[20%]">
          ...
          <form className="flex w-full flex-col items-center gap-5">
            ...
            <FormButton text={"Sign In"} dynamicClass={"w-full"} />
          </form>
          <div className="flex w-full items-center justify-center">
            <div className="w-full border border-gray-400"></div>
            <p className="w-full text-center text-sm">or sign in with</p>
            <div className="w-full border border-gray-400"></div>
          </div>
