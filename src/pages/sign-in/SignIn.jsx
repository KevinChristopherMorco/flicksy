      ...
      <div className="z-[99] flex flex-col items-center">
        <div className="flex w-[90%] flex-col items-center gap-10 rounded-md border border-gray-300 bg-[--secondary-color] p-6 md:w-[50%] md:p-10 lg:w-[40%] lg:p-10 xl:w-[30%] xl:p-10 2xl:w-[23%]">
          <div className="flex flex-col gap-2 text-center">
            <h4 className="text-3xl font-bold">{t("Welcome Back")}</h4>
          ...
          <form className="flex w-full flex-col items-center gap-5">
            ...
            <div className="flex w-full flex-col items-end gap-1">
              ...
              <Link
                to={"some-page"}
                className="text-sm font-semibold text-gray-200 transition-colors hover:text-gray-300"
              >
                {t("Forgot Password?")}
              </Link>
            </div>
            <FormButton text={t("Sign In")} dynamicClass={"w-full"} />
          </form>
          <div className="flex w-full items-center justify-center">
            <div className="w-full border border-gray-400"></div>
            <p className="w-full text-center text-sm">{t("or sign in with")}</p>
            <div className="w-full border border-gray-400"></div>
          </div>
